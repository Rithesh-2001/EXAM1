...
# # Function to convert normal date to Unix time
# def convert_to_unix(year, month, day, hour=0, minute=0, second=0):
#     normal_time = datetime(year, month, day, hour, minute, second)
#     unix_time = int(time.mktime(normal_time.timetuple()))
#     return unix_time
...
# a=convert_to_unix(year, month, day, hour, minute, second)
# print(a)

# unix_timestamp = 1730786820
# dt_object = datetime.fromtimestamp(unix_timestamp)

# print("Unix time:", unix_timestamp)  # Optional for clarity
# print("Converted time:", dt_object)
